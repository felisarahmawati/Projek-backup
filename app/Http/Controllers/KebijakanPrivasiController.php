...
class KebijakanPrivasiController extends Controller
{
    public function index()
    {
        ...
        return view('superadmin.super.kebijakanprivasi.index', compact('keb'));
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('superadmin.super.kebijakanprivasi.edit', $keb);
    }
    ...
    public function show(Request $request)
    {
        ...
        return view('superadmin.super.kebijakanprivasi.detail', $keb);
    }
