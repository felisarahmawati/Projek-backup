...
@section('content')
            ...
            <div class="modal-dialog modal-lg" style="width: 50%">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('/provinsi') }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="mb-3">
         ...
         <div class="modal fade" id="exampleModalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" style="width:35%">
                <div class="modal-content">
                    ...
                    <form action="{{ url('superadmin/super/provinsi/simpan') }}" method="POST" enctype="multipart/form-data">
                        @method("PUT")
                        {{ csrf_field() }}
    ...
    <script type="text/javascript">
        function editProvinsi(id) {
            $.ajax({
                url: "{{ url('/superadmin/super/provinsi/edit') }}",
                type: "GET",
                data: {
                    id: id
                },
