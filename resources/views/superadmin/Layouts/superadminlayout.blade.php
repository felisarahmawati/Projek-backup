...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet"
        ...
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.9.1/font/bootstrap-icons.css"><link href="{{ asset('assets/vendor/aos/aos.css') }}" rel="stylesheet">
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li class="list {{ Request::segment(2) == 'super' ? 'active' : '' }}">
                ...
                <div class="sub-menu">
                    <div class="drop-box">
                        <a href="/homeawal">Home</a>
                        <a href="/superadmin/super/tentang/index">Tentang</a>
                        <a href="/superadmin/super/faq/index">Pusat Bantuan</a>
                        <a href="/superadmin/super/kebijakanprivasi/index">kebijakan Privasi</a>
                        <a href="/tentang">Tentang Titipsini</a>
            ...
            <li class="list {{ Request::segment(2) == 'Akun' ? 'active' : ''}}">
                <div class="class iocn-link">
                    <a>
                        <i class="bi bi-person-fill"></i>
                        <span class="link_name dropBtn">Akun</span>
                    </a>
                    <i class="bx bxs-chevron-down arrow"></i>
                </div>
                <div class="sub-menu">
                    <div class="drop-box">
                        <a href="/superadmin/akun/admin/index">Admin</a>
                        <a href="#">Pelanggan</a>
                    </div>
                </div>
            </li>
